...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rozum.BrainTrainer.Identity.Api.Persistence.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Rozum.BrainTrainer.Identity.Api.Persistence.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Rozum.BrainTrainer.Identity.Api.Persistence.Entities.UserRole", b =>
                {
            ...
            modelBuilder.Entity("Rozum.BrainTrainer.Identity.Api.Persistence.Entities.UserRole", b =>
                {
                    b.HasOne("Rozum.BrainTrainer.Identity.Api.Persistence.Entities.Role", "Role")
                        .WithMany("UserRoles")
                    ...
                    b.HasOne("Rozum.BrainTrainer.Identity.Api.Persistence.Entities.User", "User")
                        .WithMany("UserRoles")
